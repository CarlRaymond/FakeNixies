...
def generate(filaments, template, folder):
	...
	# For each filament, combine its active version with all
	# other filaments' inactive versions, insert into
	...
	for idx, fil in enumerate(filaments):
		...
		tree.write(f"{folder}/en/{idx+1}.svg")
